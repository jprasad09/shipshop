...
const WithdrawMoney = () => {
    ...
    const withdrawHandler = async () => {
        if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
            ...
            await axios
                ...
                .then((res) => {
                    toast.success("The withdraw request was successful");
                });
        }
    };
    ...
    return (
        <div className="w-full h-fit p-8">
            <div className="w-full bg-white h-full rounded flex items-center justify-center flex-col py-10 px-2">
            ...
            {open && (
                <div className="w-full h-screen z-[9999] fixed top-0 left-0 flex items-center justify-center bg-[#0000004e]">
                    <div
                        className={`relative w-[95%] 800px:w-[50%] bg-white shadow rounded ${paymentMethod ? "h-[80vh] overflow-y-auto" : "h-[unset]"
                            } min-h-fit p-3`}
                    >
                        ...
                        {paymentMethod ? (
                            <div>
                                <h3 className="text-[22px] font-Poppins text-center font-[600] mb-3">
