                    ...
                    <div className="w-[90%] 800px:w-[60%] h-[90vh] 800px:h-[75vh] bg-white rounded-md shadow-sm relative p-4">
                        ...
                        <div className="block w-full 800px:flex">
                            <div className="w-full 800px:w-[50%]">
                                <img src={`${data?.images && data?.images[0]?.url}`} alt="Product" />
                                <div className="flex items-start">
                                    <Link to={`/shop/preview/${data?.shop?._id}`} className="flex">
                                        ...
                                        <div>
                                            ...
                                            <h5 className="pb-3 text-[15px]">{data?.ratings ? `${data?.ratings} Ratings` : "Ratings are not available"}</h5>
                                        </div>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <div className="w-full 800px:w-[50%] pt-5 pl-[5px] pr-[5px]">
                                <h1 className={`${styles.productTitle} text-[20px] mb-2 leading-9`}>
                                    {data?.name}
                                </h1>
