            ...
            <div className="mx-auto space-y-4">
                    ...
                    {activeTab === 2 && (
                        <div className="mt-4 pr-10">
                            <p className="text-base text-gray-500">
                                ...
                                us at support@shipshop.com with your order number and a
                    ...
                    {activeTab === 4 && (
                        <div className="mt-4 pr-10">
                            <p className="text-base text-gray-500">
                                ...
                                support@shipshop.com, or by calling us at (555) 123-4567
                                between 9am to 5pm IST, Monday to Friday.
                            </p>
                        </div>
                    )}
                </div>
                ...
                <div className="border-b border-gray-200 pb-4">
                    ...
                    {activeTab === 7 && (
                        <div className="mt-4 pr-10">
                            <p className="text-base text-gray-500">
                                We accept Visa, Mastercard, Paypal payment method. Cash on Delivery is available.
                            </p>
                        </div>
                    )}
                </div>
